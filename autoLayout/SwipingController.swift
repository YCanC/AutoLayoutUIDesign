...
//  autoLayout
//
//  Created by yasarcan on 30.03.2020.
...
class SwipingController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    let pages = [
        ...
        Page(imageName: "heart_second", headerText: "Subscribe and get coupons on our daily events", bodyText: "Get notifed of the sure to also give us any feedback you have"),
    ...
    private let nextButton: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.titleLabel?.font = UIFont.boldSystemFont(ofSize: 14)
        // let pincColor = UIColor.mainPink
    ...
    @objc private func handleNext() {
     ...
     lazy var pageControl: UIPageControl = {
        ...
        pc.pageIndicatorTintColor = .mainGrey
        return pc
    }()
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //cell.descriptionTextView.text = pages[indexPath.row].headerText
